...
def class_text_to_int(row_label):
    if row_label == 'name': return 1
    elif row_label == 'birth': return 2
    elif row_label == 'sex': return 3
    elif row_label == 'nation': return 4
    elif row_label == 'country': return 5
    elif row_label == 'id': return 6
    elif row_label == 'add': return 7
    elif row_label == 'come_time': return 8
    elif row_label == 'out_time': return 9
    elif row_label == 'diagnostic': return 10
    elif row_label == 'solution': return 11
    elif row_label == 'note': return 12
    elif row_label == 'job': return 13
    else: return None
